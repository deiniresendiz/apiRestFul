...
$app->post('/api/clientes/agregar',function (Request $request, Response $response){
    ...
    $insert = "INSERT INTO `clientes`(`nombre`, `apellidos`, `telefono`, `email`, `direccion`, `ciudad`, `departamento`) 
      VALUES (:nombre,:apellidos,:telefono,:email,:direccion,:ciudad,:departamento)";
...
$app->put('/api/clientes/actualizar/{id}',function (Request $request, Response $response){
    ...
    $update = "UPDATE `clientes` SET `nombre`=:nombre,`apellidos`=:apellidos,`telefono`=:telefono,
    `email`=:email,`direccion`=:direccion,`ciudad`=:ciudad,`departamento`=:departamento WHERE id = $id";
